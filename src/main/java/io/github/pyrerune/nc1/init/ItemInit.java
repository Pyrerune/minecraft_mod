...
public class ItemInit {
    ...
    public static final RegistryObject<Item> IRON_WOOD_SWORD = ITEMS.register("iron_wood_sword", () -> new SwordItem(NCItemTier.IRON_WOOD, 13, 6.0f, new Item.Properties().group(ItemGroup.MISC)));
