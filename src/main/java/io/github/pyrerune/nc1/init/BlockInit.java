...
public class BlockInit {
    ...
    public static final RegistryObject<Block> SOUL_CURSED_GRASS = BLOCKS.register("soul_cursed_grass", SoulCursedGrassBlock::new);
    public static final RegistryObject<Block> SOUL_CURSED_DIRT = BLOCKS.register("soul_cursed_dirt", () -> new Block(Block.Properties.create(Material.ORGANIC, MaterialColor.DIRT).hardnessAndResistance(2.0F, 1200.0F)));
    ...
    public static final RegistryObject<Block> SOULWOOD_SAPLING = BLOCKS.register("soul_wood_sapling", () -> new NCSaplingBlock(SoulWoodTree::new, Block.Properties.from(Blocks.OAK_SAPLING)));
}
